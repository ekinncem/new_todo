...
class DatabaseHelper {
  ...
  Future<int> insertEvent(String title, DateTime date, bool isTodo) async {
    final db = await database;
    return await db.insert('events', {'title': title, 'date': date.toIso8601String(), 'isTodo': isTodo ? 1 : 0});
  }
